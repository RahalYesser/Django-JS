                        ...
                        <div className="mx-2">
                          <div className="single_form mt-2">
                            ...
                            <input
                              ...
                              className="w-full input-1 rounded-md py-4 px-6 border border-solid border-body-color"
                            />
                            {errors.tarif && <div className="error">{errors.tarif}</div>}
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="w-full">
                      <div className="mx-2">
                        <div className="single_form mt-2">
                          ...
                          {errors.description && <div className="error">This field may not be blank.</div>}
                    ...
                    {/* <div className="w-full">
                                  <div className="mx-4">
                                      <div className="single_form mt-2">
                                          ...
                                          <input onChange={handleChange} required name="file" id="file" type="file" className="w-full input-1 rounded-md py-4 px-6 border border-solid border-body-color"/>
                                      </div> 
                                  </div>
                              </div> */}
                  </div>
